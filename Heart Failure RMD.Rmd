...
ggplot(data, aes(x = RaceEthnicityCategory, y = HadHeartAttack, fill = RaceEthnicityCategory)) +
  ...
  theme(
    ...
    plot.title = element_text(size = 10, face = "bold"), # Adjust title text size and style
...
# Assuming you have a data frame named 'data' with a column named 'RaceEthnicityCategory'
# If not, replace 'data' with the name of your data frame and 'RaceEthnicityCategory' with the appropriate column name.

# Count occurrences of each category
category_counts <- table(data$RaceEthnicityCategory)

# Convert the table to a data frame
category_counts_df <- as.data.frame(category_counts)
names(category_counts_df) <- c("RaceEthnicityCategory", "Count")

# Create pie chart
pie_chart <- ggplot(category_counts_df, aes(x = "", y = Count, fill = RaceEthnicityCategory)) +
